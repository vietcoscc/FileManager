...
public class FragmentDownLoad extends BaseFragment {
    ...
    public void initData() {
        ...
        listView = (ListView) v.findViewById(R.id.lv_download);
        arrItemViewFile.clear();
        arrItemViewFile = fileManager.getArrayFile(Environment.getExternalStorageDirectory().getPath() + "/" + Environment.DIRECTORY_DOWNLOADS);
